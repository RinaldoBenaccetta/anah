...
module.exports = async (options) => {
  ...
  for (const filePath of glob) {
    await getFileDatas(filePath, options, output)
  }
 ...
 */
const getFileDatas = async (filePath, options, output) => {
  ...
  if (fileContent) {
    await processDatas(fileName, options, output, fileContent)
  }
}
