...
// WORK STOPPED HERE : merge folderPages and directPages before todo.
// TODO : check if provided function, number, etc work in handlebars.
/**
 * @function validateContent
 *
 * @description
 * Check the content.
 * Return empty string if provided one is null.
...
const validatePath = (item, verbose) => {
  ...
  // TODO : add slash or remove at start, see with render what to do
